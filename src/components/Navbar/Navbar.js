...
const Navbar = () => {
  ...
  return (
    <div className="navHolder" style={{ top: visibleNav ? '0' : '-150px', position: 'fixed', zIndex: 100 }}
         ref={refCart}>
      <div className="prenav">free shipping</div>
      <nav className="navbar">
        <NavLink className="logo-cont" onClick={() => {
          setCartVisibility(false)
          window.scrollTo(0, 0)
        }} to="/">
        ...
        <div className="navbar-items">
          <div className="navbar-left">
            ...
            >
              <NavLink className="man-nav" onClick={() => { setCartVisibility(false) }} to="/man">Man<i
                className={`arrow down`}></i></NavLink>
            ...
            >
              <NavLink className="woman-nav" onClick={() => { setCartVisibility(false) }} to="/woman">Woman<i
                className={`arrow down`}></i></NavLink>
        ...
        {items && items.length && <button style={{ display: cartButtonVisibility ? 'initial' : 'none', zIndex: 1000 }}
